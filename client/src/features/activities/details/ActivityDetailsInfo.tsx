    ...
    return (
        <Paper sx={{ mb: 2 }}>
            ...
            <Grid container sx={{alignItems: "center", pl: 2, py: 1}}>
                ...
                <Grid sx={{ flexDirection: "row", size: '11', display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                    <Typography>
                        {activity.venue}, {activity.city}
                    </Typography>
                    <Button onClick={() => setMapOpen(!mapOpen)} variant="outlined" color="info">
